    ...
    "Q&A": [
        {
            ...
            author: "김민수",
            date: new Date("2026-06-15").toLocaleString("ko-KR"),
            reply: 5,
            badge: "qa-badge",
            views: 321,
            likedUsers: ["박지호", "최유진"],
            ...
            comments: [
                {
                    ...
                    author: "이서연",
                    date: new Date("2026-06-15").toLocaleString("ko-KR"),
                    likedUsers: ["박지호", "최유진"], // 기존 likes: 8 대신 배열 사용 (현재 2명)
                    content: "작은 프로젝트라면 Context API만으로도 충분합니다. 규모가 커질 때 Redux를 사용하는 것을 추천합니다.",
                },
                {
                    id: 2,
                    author: "박지호",
                    date: new Date("2026-06-15").toLocaleString("ko-KR"),
                    likedUsers: ["이서연"],
                    content: "상태를 최소화하는 것이 중요합니다. props drilling이 심해질 때 Context를 사용하는 편입니다.",
                },
                {
                    id: 3,
                    author: "최유진",
                    date: new Date("2026-06-16").toLocaleString("ko-KR"),
                    likedUsers: [],
                    content: "최근에는 Redux Toolkit을 많이 사용합니다. 기존 Redux보다 코드가 훨씬 간단합니다.",
                },
            ],
        },
        {
            ...
            author: "박지호",
            date: new Date("2026-06-13").toLocaleString("ko-KR"),
            reply: 12,
            badge: "qa-badge",
            views: 287,
            likedUsers: ["박지호", "최유진"],
            ...
            comments: [
                {
                    ...
                    date: new Date("2026-06-13").toLocaleString("ko-KR"),
                    likedUsers: ["이서연", "최유진"],
                    content: "의존성 배열에 있는 값이 변경될 때만 useEffect가 다시 실행됩니다.",
                },
                {
                    id: 2,
                    author: "이서연",
                    date: new Date("2026-06-13").toLocaleString("ko-KR"),
                    likedUsers: ["장현우"],
                    content: "eslint-plugin-react-hooks를 사용하면 누락된 의존성을 쉽게 확인할 수 있습니다.",
                },
            ],
        },
    ],
    ...
    "팁 공유": [
        {
            ...
            author: "이서연",
            date: new Date("2026-06-14").toLocaleString("ko-KR"),
            reply: 15,
            badge: "tip-badge",
            views: 441,
            likedUsers: ["박지호", "최유진"],
            ...
            comments: [
                {
                    ...
                    author: "장현우",
                    date: new Date("2026-06-14").toLocaleString("ko-KR"),
                    likedUsers: ["김민수", "박지호", "최유진"],
                    content: ":root와 data-theme 속성을 함께 사용하면 구현이 더욱 편리합니다.",
                },
                {
                    id: 2,
                    author: "김민수",
                    ...
                    content: "CSS 변수만으로도 대부분의 다크모드를 구현할 수 있습니다.",
                },
            ],
        },
        {
            ...
            author: "장현우",
            date: new Date("2026-06-11").toLocaleString("ko-KR"),
            reply: 9,
            badge: "tip-badge",
            views: 278,
            likedUsers: ["박지호", "최유진"],
            ...
            comments: [
                {
                    ...
                    date: new Date("2026-06-11").toLocaleString("ko-KR"),
                    likedUsers: ["임나영", "이서연"],
                    content: "try-catch가 가장 읽기 쉽고 유지보수도 편합니다.",
                },
            ],
        },
        {
            ...
            author: "임나영",
            date: new Date("2026-06-08").toLocaleString("ko-KR"),
            reply: 18,
            badge: "tip-badge",
            views: 602,
            likedUsers: ["박지호", "최유진"],
            ...
            comments: [
                {
                    ...
                    author: "이서연",
                    date: new Date("2026-06-08").toLocaleString("ko-KR"),
                    likedUsers: ["장현우", "최유진", "김민수"],
                    content: "단축키를 외우면 개발 속도가 정말 빨라집니다.",
                },
            ],
        },
    ],
    ...
    "자유게시판": [
        {
            ...
            author: "최유진",
            date: new Date("2026-06-12").toLocaleString("ko-KR"),
            reply: 31,
            badge: "free-badge",
            views: 712,
            likedUsers: ["박지호", "최유진"],
            ...
            comments: [
                {
                    ...
                    author: "강도현",
                    date: new Date("2026-06-12").toLocaleString("ko-KR"),
                    likedUsers: ["한지민", "임나영", "박지호"],
                    content: "저도 비슷한 과정으로 공부했는데 정말 공감됩니다.",
                },
                {
                    id: 2,
                    author: "한지민",
        ...
        },
        {
            ...
            author: "강도현",
            date: new Date("2026-06-09").toLocaleString("ko-KR"),
            reply: 22,
            badge: "free-badge",
            views: 503,
            likedUsers: ["박지호", "최유진"],
            ...
            comments: [
                {
                    ...
                    date: new Date("2026-06-09").toLocaleString("ko-KR"),
                    likedUsers: ["이서연", "한지민"],
                    content: "CSS만으로도 깔끔한 포트폴리오를 만들 수 있군요!",
                },
            ],
        },
        {
            ...
            author: "한지민",
            date: new Date("2026-06-06").toLocaleString("ko-KR"),
            reply: 14,
            badge: "free-badge",
            views: 388,
            likedUsers: ["박지호", "최유진"],
            ...
            comments: [
                ...
                },
                {
                    ...
                    date: new Date("2026-06-06").toLocaleString("ko-KR"),
                    likedUsers: ["강도현"],
                    content: "온라인 스터디라면 저도 참여하고 싶습니다.",
                },
            ],
        },
    ],
